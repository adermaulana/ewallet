...
<body class="contact-page">
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Hubungi Kami</h1>
              <p class="mb-0">Kami siap membantu Anda. Hubungi tim kami untuk pertanyaan, masukan, atau dukungan teknis. Jam operasional kami Senin-Jumat pukul 09.00-17.00 WIB.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Bagian Kontak -->
    <section id="contact" class="contact section mt-3" >
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            <div class="info-item d-flex" data-aos="fade-up" data-aos-delay="300">
              ...
              <div>
                <h3>Alamat</h3>
                <p>Perintis, Makassar, Indonesia</p>
              </div>
            </div><!-- End Info Item -->
