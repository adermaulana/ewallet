      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>About Us<br></h1>
              <p class="mb-0">Kami adalah penyedia solusi pembayaran digital terdepan di Makassar yang menghadirkan kemudahan transaksi melalui teknologi QR Code. Dengan inovasi terbaru dalam sistem e-wallet, kami berkomitmen memberikan pengalaman pembayaran yang aman, cepat, dan mudah untuk semua kalangan.</p>
            </div>
          </div>
        </div>
      </div>
